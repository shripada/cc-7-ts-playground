...
console.assert(empty.hi === 'Some stuff1', 'Empty should see the hi property via prototypal inheritence'); // Automating tests via assert
...
const num = 1;
console.assert(num.hi === 'Some stuff1', 'Even literals should get the prop from their prototype');
const displayable = {
    display() {
...
console.assert(displayable.hi === 'Displayable Hi', 'any object created using literal syntax must get all props of Object.prototype');
console.assert(aDisplayable.hi === 'Displayable Hi', 'any object created using literal syntax must get all props of Object.prototype');
